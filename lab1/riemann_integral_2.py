...
#anim.save('riemann_sum.mp4', writer=animation.FFMpegWriter(fps=30))

print("compare left mid right")
for i in [100,200,400,800]:
    print("count of point is ", i)
    print(calculate_integral(f, a, b, i, "left"))
    print(calculate_integral(f, a, b, i, "mid"))
    print(calculate_integral(f, a, b, i, "right"))
    print()
